...
export const PHOTOS_REVERSE_GEOCODE_API = PHOTOS_PREFIX + OPS_PREFIX + "/reverseGeocode";
export const PHOTOS_REVERSE_GEOCODE_ALL_PHOTOS_API = PHOTOS_PREFIX + OPS_PREFIX + "/reverseGeocodeAllPhotos";
